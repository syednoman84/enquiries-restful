...
public class MailingList implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (added == null) {
            if (other.added != null) return false;
        } else if (!added.equals(other.added)) return false;
        if (email == null) {
        ...
        if (sentNumber == null) {
            if (other.sentNumber != null) return false;
        } else if (!sentNumber.equals(other.sentNumber)) return false;
        return true;
    }

    @Override
    public String toString() {
        return "MailingList [id=" + id + ", name=" + name + ", email=" + email + ", added=" + added + ", sentNumber=" + sentNumber + "]";
    }
